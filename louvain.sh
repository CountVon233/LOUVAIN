...
max_level=2
beta=0.80
root_path=/home/countvon/git_repo/for_SumInc
# inc
ipath=${root_path}/dataset/large/${name}/${percentage}/${name}.base
opath=${root_path}/dataset/louvain_bin/${name}_${percentage}
# no-inc
